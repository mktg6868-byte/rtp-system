...
// ====================================================================
// 🔓 FIX IFRAME BLOCKING → ALLOW EMBEDDING ON ANY WEBSITE
// ====================================================================
...
const ACCESS_TOKEN =
  "c574d3c7b814b2efa4e62d179764b1864766adc8700240454d7fde1c56c3a855";
...
// ====================================================================
// PREMIUM AUTO-THEME IFRAME PAGE
// ====================================================================
...
<style>
/* -----------------------------------
   AUTO-THEME DETECTION VARIABLES
----------------------------------- */
:root {
    --accent: #00fff6;
    --accent2: #bbff00;
...
.progress-bar {
    ...
    background: linear-gradient(90deg, #ff3e57, #ff9800, #fce83a, #4caf50);
}
...
function renderGames() {
    ...
    const subset = list.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
